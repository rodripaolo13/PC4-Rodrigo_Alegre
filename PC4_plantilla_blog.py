...
col1.image("0e1f7650-f045-478e-8aec-eeeb7b4e08f1.png", caption='Aquí puedes escribir una tiqueta debajo de la imagen', width=300)
...
enlace = f'<a href="https://youtu.be/g4Sym2rGX3A?si=UqlIhNxYwQBoA1Hv" target="_blank"><button>Tema 1 Pensamiento Computacional</button></a>'
...
sidebar.markdown("<h1 style='text-align: center;'>Gráficos realizados en práctica durante el semestre</h1>", unsafe_allow_html=True)
